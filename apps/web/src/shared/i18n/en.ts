...
export const en: typeof ja = {
  ...
  keymap: {
    ...
    resetDescription: "This restores all key assignments, enabled layers, LED colors, LED brightness limit, and encoder direction to their defaults and saves them to the device immediately.",
    resetCancel: "Cancel",
