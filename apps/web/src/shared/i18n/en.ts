...
export const en: typeof ja = {
    ...
    products: [
      {
        status: "Available",
        name: "OctGear",
        description: "Temporary product page for the 8-key RP2040 board with an A/B/SW rotary encoder.",
      },
    ],
    keys: "Keys",
    encoder: "Encoder",
  ...
  hardware: {
    ...
    keys: "Keys",
    encoder: "Encoder",
    encoderValue: (pinCount) => `${pinCount}-pin A/B/SW`,
  ...
  keymap: {
    ...
    resetDescription: "This restores all key assignments, enabled layers, and LED colors to their defaults and saves them to the device immediately.",
    resetCancel: "Cancel",
