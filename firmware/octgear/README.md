...
- GPIO 14の外付けWS2812Bへ5 pixels分の同一色を送るlayer、remapper、rescue状態表示。対応boardでは内蔵WS2812にもミラー
...
| --- | --- |
| Matrix GPIO、control / layer count、encoder tuning、default layer colors、外付けWS2812B GPIO / pixel count | `hardware/octgear/profile.json` |
