...
- GPIO 14の外付けWS2812Bによるlayer、remapper、rescue状態表示。対応boardでは内蔵WS2812にもミラー
...
| --- | --- |
| Matrix GPIO、control / layer count、encoder tuning、default layer colors、外付けWS2812B GPIO | `hardware/octgear/profile.json` |
