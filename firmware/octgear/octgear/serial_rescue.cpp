...
void printHelp() {
  ...
  Serial.println(F("  get <layer> <key 1-8>"));
  Serial.println(F("  none <layer> <key 1-8>"));
  Serial.println(F("  key <layer> <key 1-8> <modifier> <keycode> [keycode...]"));
  Serial.println(F("  consumer <layer> <key 1-8> <usage>"));
  Serial.println(F("  cycle <layer> <key 1-8>"));
  Serial.println(F("  hold <layer> <key 1-8> <target layer>"));
